    ...
    <section id="portfolio" className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-10">
        {projects.map((project) => (
          <article
            key={project.id}
            className="bg-[#121826]/70 rounded-[4px] p-8 md:p-12 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(6,172,254,0.15)] group"
          >
            <div className="lg:col-span-7 flex flex-col items-start">
              ...
              <h3 className="text-3xl md:text-[32px] font-extrabold font-[var(--font-lato)] text-white mb-4 leading-snug group-hover:text-[#06ACFE] transition-colors">
                {project.title}
              </h3>
            ...
            {/* Custom Category Gradient Preview Box */}
            <div
