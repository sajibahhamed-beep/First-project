      ...
      .then((data) => {
        if (data.blogs && data.blogs.length > 0) {
          const mapped = data.blogs.map((b: any) => ({
            ...
            image: b.coverImage || "/assets/blog_thumb.png",
          }));
          setPosts(mapped);
        }
      })
            ...
            >
              ...
              <div className="p-8 flex flex-col justify-between flex-1">
                <div>
                  ...
                  <h3 className="text-2xl font-bold font-[var(--font-lato)] text-white mb-4 group-hover:text-[#06ACFE] transition-colors leading-snug">
                    {post.title}
                  </h3>
